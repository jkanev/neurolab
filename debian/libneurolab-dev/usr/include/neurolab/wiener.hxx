...
class Wiener: public StochVariable, public RandN
{
private:
	double dDiff;
	double dSum;
...
{
private:
	double dW; // single weight
	double dN; // number of processes
	double dLambda; // single rate
	double dNRc; // relative coincidence width
	double dLambdaRc; // relative coincidence rate
public:
	/// Constructor.
	...
	WienerCpp( const class Time *time, double w, double n, double lambda, double n_rc, double lambda_rc);
	~WienerCpp();
